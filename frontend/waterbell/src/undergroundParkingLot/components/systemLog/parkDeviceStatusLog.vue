    ...
    <table class="table table-hover table-bordered table-bordered">
      <thead class="thead-dark">
        <tr>
          ...
          <th scope="col" class="text-center" style="width: 200px">상태</th>
        </tr>
      </thead>
...
export default defineComponent({
  ...
  setup() {
    ...
    const setList = () => {
      ...
      apiClient
        .get(
          `/system/manager/facilities/${facilityId}/response/logs/${currentPage.value}`,
          {
            params: {
        ...
        .then((res) => {
          ...
          facilityName.value = res.data.facilityName
        })
        .catch((error) => {
          console.log(error)
        })
