...
#AWS IoT 관련 설정
THING_NAME = 'rasp'
ENDPOINT = "a3kqjba8huf6r2-ats.iot.us-east-2.amazonaws.com"
CERTPATH =  "/home/jjhjjh/Desktop/kkyIoTCore/rasp.cert.pem" # cert파일 경로
KEYPATH = "/home/jjhjjh/Desktop/kkyIoTCore/rasp.private.key" # key 파일 경로
CAROOTPATH = "/home/jjhjjh/Desktop/kkyIoTCore/root-CA.crt" # RootCaPem 파일 경로
...
def on_message_cam3(client, userdata, msg):
    ...
    global arduino
    topic = "CAM1"
    publisher(arduino, topic, msg.payload.decode())
